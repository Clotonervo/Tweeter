...
//    }
    ...
    public PostResponse post(Status postedStatus, String urlPath) throws IOException {
        ClientCommunicator clientCommunicator = new ClientCommunicator(SERVER_URL);
        return clientCommunicator.doPost(urlPath, postedStatus, null, PostResponse.class);
    }
    ...
    /*
      ...
      */
    public User aliasToUser(String alias){                                          //TODO: Implement this API
        for (Map.Entry<User, List<User>> entry : userFollowing.entrySet()) {
...
//    }
    ...
    public FollowResponse followUser(Follow follow, String urlPath) throws IOException {
        ClientCommunicator clientCommunicator = new ClientCommunicator(SERVER_URL);
        return clientCommunicator.doPost(urlPath, follow, null, FollowResponse.class);
    }
...
//    }
    ...
    public SignOutResponse signOutUser(String userAlias, String urlPath) throws IOException{
        ClientCommunicator clientCommunicator = new ClientCommunicator(SERVER_URL);
        return clientCommunicator.doPost(urlPath, userAlias, null, SignOutResponse.class);
    }
